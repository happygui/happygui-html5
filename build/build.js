...
require.register("richthegeek-raphael/raphael.js", function(exports, require, module){
// ┌────────────────────────────────────────────────────────────────────┐ \\
...
(function () {
    ...
    (function (matrixproto) {
        ...
        matrixproto.getCollections = function (i) {
            return +this[Str.fromCharCode(97 + i)].toFixed(4);
        };
        matrixproto.toString = function () {
            return R.svg ?
                "matrix(" + [this.getCollections(0), this.getCollections(1), this.getCollections(2), this.getCollections(3), this.getCollections(4), this.getCollections(5)].join() + ")" :
                [this.getCollections(0), this.getCollections(2), this.getCollections(1), this.getCollections(3), 0, 0].join();
        };
        matrixproto.toFilter = function () {
            return "progid:DXImageTransform.Microsoft.Matrix(M11=" + this.getCollections(0) +
                ", M12=" + this.getCollections(2) + ", M21=" + this.getCollections(1) + ", M22=" + this.getCollections(3) +
                ", Dx=" + this.getCollections(4) + ", Dy=" + this.getCollections(5) + ", sizingmethod='auto expand')";
        };
        ...
        matrixproto.toTransformString = function (shorter) {
            ...
            if (s.isSimple) {
                ...
                return "m" + [this.getCollections(0), this.getCollections(1), this.getCollections(2), this.getCollections(3), this.getCollections(4), this.getCollections(5)];
            }
        };
    })(Matrix.prototype);
...
require.alias("happygui-win8-datastore/index.js", "happygui/deps/win8-datastore/index.js");
...
require.alias("richthegeek-raphael/raphael.js", "boot/deps/raphael/raphael.js");
require.alias("richthegeek-raphael/raphael-min.js", "boot/deps/raphael/raphael-min.js");
require.alias("richthegeek-raphael/raphael.js", "boot/deps/raphael/index.js");
require.alias("adobe-webplatform-eve/eve.js", "richthegeek-raphael/deps/eve/eve.js");
require.alias("adobe-webplatform-eve/eve.js", "richthegeek-raphael/deps/eve/index.js");
require.alias("adobe-webplatform-eve/eve.js", "adobe-webplatform-eve/index.js");
...
require.alias("happygui-win8-datastore/index.js", "boot/deps/win8-datastore/index.js");
